...
import { RegistryAlgebra } from "./registries/algebra";
...
export const mainnetRegistryUbeswapV3 = (kit: ContractKit) =>
  new RegistryAlgebra(
    "ubeswap-v3",
    kit.web3 as unknown as Web3,
    "0x9e7C3C558173B08B3050863dde8104657e80a1c6"
  );

export const mainnetStCeloRegistry = (kit: ContractKit) => {
...
export const mainnetRegistriesWhitelist = (kit: ContractKit) => [
  ...
  // Liquid staking
  mainnetStCeloRegistry(kit),

  // Unswap V3 Forks
  mainnetRegistryUbeswapV3(kit),
];
