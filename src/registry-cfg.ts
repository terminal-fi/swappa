...
export const mainnetRegistryMoola =
	(web3: Web3) => new RegistryAave(web3, "0x7AAaD5a5fa74Aec83b74C2a098FBC86E17Ce4aEA")
export const mainnetRegistryUbeswap =
	(web3: Web3) => new RegistryUniswapV2(web3, "0x62d5b84bE28a183aBB507E125B384122D2C25fAE")
export const mainnetRegistrySushiswap =
	(web3: Web3) => new RegistryUniswapV2(web3, "0xc35DADB65012eC5796536bD9864eD8773aBc74C4")
export const mainnetRegistryMobius =
	(web3: Web3) => new RegistryStatic([
...
export const mainnetRegistryMoolaV2 =
	(web3: Web3) => new RegistryAaveV2(web3, "0xD1088091A174d33412a968Fa34Cb67131188B332")
export const mainnetRegistryCeloDex =
	(web3: Web3) => new RegistryUniswapV2(web3, "0x31bD38d982ccDf3C2D95aF45a3456d319f0Ee1b6", {
